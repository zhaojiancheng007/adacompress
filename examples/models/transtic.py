...
from layers.layers_transtic import RSTB, MultistageMaskedConv2d, RSTB_PromptModel
...
class TIC_PromptModel_first2(nn.Module):
    ...
    """
    def __init__(self, N=128, M=192, prompt_config=None, input_resolution=(512,512)):
        super().__init__()
